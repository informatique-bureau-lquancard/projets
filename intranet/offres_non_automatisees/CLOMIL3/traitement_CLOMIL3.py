            ...
            for row in reader:
                ...
                if "Bordeaux" in row[0]:
                    ...
                    if row[5]=='':
                        ...
                        if row[4]=='Pessac-Léognan': #on traite le cas spécifique des pessac leognan blanc
                        ...
                        if row[3]!="" :
                            chateau=unidecode(row[4])+' '+unidecode(row[3])
                            chateau=chateau.replace('â','a')
                            chateau=chateau.replace('é','e')
                            chateau=chateau.replace('è','e')
                            chateau=chateau.replace('ô','o')
