            ...
            for row in reader:
                ...
                if row[1]=='':
                    ...
                    if row[6]!="":
                        ...
                        if row[5]=="" or row[5]=="COFFRET":
                            quantite = 0
                            uqte = ""
                        else:
                            uqte=re.findall("[0-9]+",row[5])[0]
                            quantite = uqte
                    ...
                    if row[5]=='':
                        ...
                        conditionnement=conditionnement.replace('COFFRETMO/','CC')
                        conditionnement=conditionnement.replace('COFFRETBO/','CC')
                    ...
                    if prix == 0:
                        commentaires = row[7]+' - '+'VERIF CDT : '+row[5]
                    else:
                ...
                if bEcrire==1:
                    ...
                    trou=''
                    newRow=[chateau,annee,formatb,prix,quantite,conditionnement,commentaires,officieux]
